    ...
    exception has no reference to the xml file that failed, and is swallowed
============================================================
    ...
    Is it possible to use a schema for the XML or is there no schema?
    ...
    =============================
      ...
      private void processAfterOT(KafkaMessage message, OTResponse otResponse) {
        try {
            ...
            Why would the wait function not use some internal eventing mechanism instead of polling the folder?
