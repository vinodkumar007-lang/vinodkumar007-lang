...
Logging format assumes that no concurrent messages can be processed, there is no golden thread in the logs to track specific files?
...
Has url been verified to be none empty?
            =============================
                // ✅ Create input folder
            ...
            I'm ok with this call, where you could be reusing existing folders, but will that not be an issue if there are any lingering values?
            ...
            None of the input values are being sanitized, this is security risk
