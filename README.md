...
public class KafkaListenerService {
    ...
    public ApiResponse listen() {
        ...
        try (KafkaConsumer<String, String> consumer = new KafkaConsumer<>(props)) {
            ...
            if (records.isEmpty()) {
                ...
                return new ApiResponse(
                        ...
                        "info",
                        new SummaryPayloadResponse("No new messages to process", "info", new SummaryPayload()).getSummaryPayload()
                );
            }
            ...
            for (ConsumerRecord<String, String> record : records) {
                try {
                    ...
                    return new ApiResponse(
                            ...
                            "error",
                            new SummaryPayloadResponse("Error processing message", "error", new SummaryPayload()).getSummaryPayload()
                    );
                }
            }
        } catch (Exception e) {
            ...
            return new ApiResponse(
                    ...
                    "error",
                    new SummaryPayloadResponse("Kafka error", "error", new SummaryPayload()).getSummaryPayload()
            );
        }
        ...
        return new ApiResponse(
                ...
                "info",
                new SummaryPayloadResponse("No messages processed", "info", new SummaryPayload()).getSummaryPayload()
        );
    }

    private ApiResponse processSingleMessage(KafkaMessage message) {
        if (message == null) {
            return new ApiResponse("Empty message", "error", new SummaryPayloadResponse("Empty message", "error", new SummaryPayload()).getSummaryPayload());
        }
        ...
        SummaryPayloadResponse apiPayload = new SummaryPayloadResponse("Batch processed successfully", "success", summaryPayload);

        return new ApiResponse(
                apiPayload.getMessage(),
                apiPayload.getStatus(),
                apiPayload.getSummaryPayload()
        );
    }
