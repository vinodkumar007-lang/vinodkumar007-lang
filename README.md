...
source.systems[9].name=NEDTRUST
source.systems[9].url=${OT_SERVICE_CADNT1Service_URL}
source.systems[0].token=otds-token-dev

source.systems[10].name=NEDTRUST
source.systems[10].url=${OT_SERVICE_CADNT9Service_URL}
source.systems[0].token=otds-token-dev
