...
public class KafkaListenerService {
    ...
    public Map<String, Object> listen() {
        ...
        try {
            ...
            // Optionally, send a final summary or status message once all processed
            // sendFinalResponseToKafka(...) could be modified accordingly

            Map<String, Object> response = new HashMap<>();
            response.put("status", "success");
            response.put("message", recentMessages.size() + " messages processed and appended to summary.json");
            return response;
