...
public class KafkaListenerService {
    ...
    private ApiResponse processSingleMessage(KafkaMessage message) {
        ...
        metadata.setSummaryProcessedFiles(processedFiles);
        ...
        try {
            ...
            File summaryJsonFile = SummaryJsonWriter.writeSummaryJson(summaryPayload);
            ...
            return new ApiResponse("Failed to write or upload summary.json: " + e.getMessage(), "error", null);
        }
    ...
    private String buildBlobPath(String sourceSystem, long timestamp, String batchId,
        ...
        // Example folder structure: /sourceSystem/YYYYMMDD/batchId/uniqueConsumerRef/jobName/folder/customerAccountNumber/fileName
        String datePart = Instant.ofEpochMilli(timestamp).toString().substring(0, 10).replace("-", "");
    ...
    private String buildSummaryJsonBlobPath(KafkaMessage message) {
        String datePart = Instant.ofEpochMilli(message.getTimestamp()).toString().substring(0, 10).replace("-", "");
