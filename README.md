...
azure.blob.storage.account =https://nsndvextr01.blob.core.windows.net/nsnakscontregecm001
   ...
   Properties props = new Properties();
        props.put("bootstrap.servers", "nsnxeteelpka01.nednet.co.za:9093,nsnxeteelpka02.nednet.co.za:9093,nsnxeteelpka03.nednet.co.za:9093"); // replace with your config
        props.put("group.id", "str-ecp-batch");           // use consistent group ID
